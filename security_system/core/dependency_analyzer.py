...
### 📞 في حالة الطوارئ:
- تشغيل: `python security_system/core/dependency_analyzer.py --emergency`
- مراجعة: `security_system/docs/DEPENDENCY_SECURITY_GUIDE.md`
...
def main():
    ...
    if args.emergency:
        ...
        print("\n📊 راجع التقرير الكامل في: security_system/reports/")
