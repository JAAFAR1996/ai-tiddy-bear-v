# Performance Fixes for health_checks.py

File: `C:\Users\jaafa\Desktop\ai teddy bear\src\infrastructure\database\health_checks.py`

## Issue 1: Multiple nested loops detected (58)
- **Type**: nested_loops
- **Line**: 1
