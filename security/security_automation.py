...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("security/automation.log", encoding="utf-8"),
...
class SecurityAutomation:
    ...
    def __init__(self, config_path: str = "security/automation_config.json"):
        ...
        (self.security_dir / "alerts").mkdir(exist_ok=True)
